...
---desc: Defines simple bullet prefabs
---------------------------------------------------------------------------------------------------
...
---1) have bullet sprite with a specific color
...
---@param color_index number indicate color of the bullet
function BulletBase:init(bullet_type_name, color_index, group, blink_time, size)
...
function BulletBase:changeSpriteTo(bullet_type_name, color_index)
    self.bullet_type_name = bullet_type_name
    self.blink_time = nil
    self.color_index = color_index
